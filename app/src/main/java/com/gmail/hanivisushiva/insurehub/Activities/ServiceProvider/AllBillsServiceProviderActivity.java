...
public class AllBillsServiceProviderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_bills_service_provider);
    ...
    private void getAllBills(String sid){

        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading please wait....");
        progressDialog.show();

        Call<ServiceProviderAllBillsModel> call = RetrofitClient.getmInstance().getApi().service_provider_get_all_bills(sid);
