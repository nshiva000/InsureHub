package com.gmail.hanivisushiva.insurehub.Model.LoginModel;
...
public class Data {
    ...
    @SerializedName("discountposition")
    @Expose
    private String discountposition;
    ...
    public void setDiscountposition(String discountposition) {
